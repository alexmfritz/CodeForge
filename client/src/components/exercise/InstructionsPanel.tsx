...
import { DEFAULT_SOLUTION_GATE } from '@codeforge/shared/constants';
import { useAppSelector } from '../../features/store';
import { selectUniqueAttempts, selectIsComplete } from '../../features/progressSlice';
...
export default function InstructionsPanel({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden" style={{ backgroundColor: 'var(--bg-surface)', borderRight: '1px solid var(--border)' }}>
